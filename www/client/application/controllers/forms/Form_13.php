...
class Form_13 extends MY_Controller {
	function index() {
		$this->load->view('includes/after_login/head');
		$this->load->view('forms/form_13');
	}

	function form_13_validate() {
		...
		$this->form_validation->set_rules('communication_facilities_tel_unit', 'communication_facilities_tel_unit*communication facilities tel unit', 'trim|required');
		$this->form_validation->set_rules('communication_facilities_fax_unit', 'communication_facilities_fax_unit*communication facilities fax unit', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_2mbps_shared', 'internet_facilities_2mbps_shared*internet facilities 2mbps shared', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_4mbps_shared', 'internet_facilities_4mbps_shared*internet facilities 2mbps shared', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_10mbps_shared', 'internet_facilities_10mbps_shared*internet facilities 10mbps shared', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_2mbps_cir', 'internet_facilities_2mbps_cir*internet facilities 2mbps cir', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_4mbps_cir', 'internet_facilities_4mbps_cir*internet facilities 4mbps cir', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_10mbps_cir', 'internet_facilities_10mbps_cir*internet facilities 10mbps cir', 'trim|required');
		$this->form_validation->set_rules('internet_facilities_20mbps_cir', 'internet_facilities_20mbps_cir*internet facilities 20mbps cir', 'trim|required');
