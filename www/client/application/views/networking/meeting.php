                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select name="meeting_location" form="crd_form" class="form-control">
									...
									<?php } ?>
                                    <option value="our_stall">Our Stall</option>
                            ...
                            <div class="col-md-9">
                                <form action="<?= base_url('mou_schedule_submit.html') ?>" method="post" id="crd_form">
                                <h4>Select Time</h4>
                                ...
                                <div class="text-right">
                                        ...
                                        <button type="button" class="btn btn-primary btn-lg js-form_btn">Proceed</button>
...
<script>
	$(function () {
		doFormValidation({
			...
			'urlValidator': "<?php echo base_url("mou_schedule_validate.html"); ?>",
    ...
    $(document).on('click', '.day-select li', function (e) {
        ...
        $.ajax({
			type:    'post',
			url:     '<?= base_url('networking/get_available_time') ?>',
			data:    {
				day: day,
				date: date,
