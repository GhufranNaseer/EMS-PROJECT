...
<div class="content-wrapper" data-page="organizer-list">
...
<script type="text/javascript">
	$(document).ready(function () {
		oTable = $('#crud-table').dataTable($.extend(datatable_settings, {
			"sAjaxSource": '<?php echo base_url('organizer-datatable.html'); ?>',
		}));
        ...
        $('#crud-table').on('click', '.btn-detail', function() {
            ...
            $.ajax({
                url: "<?php echo base_url('exhibitor_team/get_organizer_details'); ?>",
                method: 'POST',
                data: { id: id },
