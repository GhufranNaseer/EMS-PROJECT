...
<div class="content-wrapper" data-page="form_18">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="<?= base_url('inventory/order_forms/form_18_submit') ?>" method="post" id="crd_form"
                              enctype="multipart/form-data">

                            <input type="hidden" name="form_id"
                                   id="form_id" placeholder="form_id" value="18">
                           ...
                           id="stand_no" placeholder="Stand No">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                      ...
                                      <h4><b>English & Urdu speaking temporary staff for the stand shall be provided, please specify requirement:</b></h4>

                                    <table class="table table-bordered">
                                        <tr>
                                            <th rowspan="2" class="text-center">Temporary Staff</th>
                                            <th colspan="3" class="text-center">Number</th>
                                            <th colspan="2" class="text-center">Duration</th>
                                            <th rowspan="2" class="text-center">No. of Days</th>
                                            <th rowspan="2" class="text-center">Charges
                                                (US$)</th>
                                            <th rowspan="2" class="text-center">Amount
                                                (US$)</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="datetime" class="form-control" id="item_2" name="item_2"></td>
                                            <td>0</td>
                                            <td><input type="date" class="form-control" id="item_3" name="item_3"></td>
                                            <td><input type="date" class="form-control" id="item_4" name="item_4"></td>
                                            <td><input type="text" class="form-control" id="item_5" name="item_5"></td>
                                            <td>$250.00</td>
                                            <td>$0.00</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Secretarial</td>
                                            <td><input type="text" class="form-control" id="item_6" name="item_6"></td>
                                            <td><input type="datetime" class="form-control" id="item_7" name="item_7"></td>
                                            <td>0</td>
                                            <td><input type="date" class="form-control" id="item_8" name="item_8"></td>
                                            <td><input type="date" class="form-control" id="item_9" name="item_9"></td>
                                            <td><input type="text" class="form-control" id="item_10" name="item_10"></td>
                                            <td>$250.00</td>
                                            <td>$0.00</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Receptionist</td>
                                            <td><input type="text" class="form-control" id="item_11" name="item_11"></td>
                                            <td><input type="datetime" class="form-control" id="item_12" name="item_12"></td>
                                            <td>0</td>
                                            <td><input type="date" class="form-control" id="item_13" name="item_13"></td>
                                            <td><input type="date" class="form-control" id="item_14" name="item_14"></td>
                                            <td><input type="text" class="form-control" id="item_15" name="item_15"></td>
                                            <td>$200.00</td>
                                            <td>$0.00</td>
                                        </tr>
                                    </table>

                                    <h4 style="float: right">Add charges for uniform @ US$ 150 each<br/><b>Total US$</b> $0.00</h4>

                                    <h4><b>Remarks:</b></h4>
                                    <ul>
                                        <li>Additional charge of 20% shall apply if orders made on site, subject to availability of staff.</li>
                                        <li>If an exhibitor wants to order uniform for its staff, one (1) month prior notice along with full advance
                                            payment is necessary for compliance of the order. </li>
                                        <li>All the charges mentioned above are applicable for the entire show.</li>
                                    </ul>
                                    <h4><b>Payment:</b></h4>
                                    <ul><li>The Exhibitor’s order must be accompanied by full payment. Please contact the Event Manager.</li></ul>
                                </div>
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("inventory/order_forms/form_18_validate/doError"); ?>",
