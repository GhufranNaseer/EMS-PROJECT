...
<div class="content-wrapper" data-page="form_15">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="<?= base_url('inventory/order_forms/form_15_submit') ?>" method="post" id="crd_form"
                              enctype="multipart/form-data">

                            <input type="hidden" name="form_id"
                                   id="form_id" placeholder="form_id" value="15">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="stand_no"
                           ...
                           <p>Please complete the table below for quotation in respect of the required compressed air connection at
                               the stand and submit to the event manager </p>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-center">Air Pressure</th>
                                            <th rowspan="2" class="text-center">No. of Connections</th>
                                            <th rowspan="2" class="text-center">Charges</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">Upto5</td>
                                            <td class="text-center"><input type="text" id="item_1" name="item_1"></td>
                                            <td class="text-center">$150.00</td>
                                            <td class="text-center">$0.00</td>

                                        </tr>
                                        <tr>
                                            <td class="text-center">Special requirement
                                                (Please specify)</td>
                                            <td class="text-center">200</td>
                                            <td class="text-center">Above 5</td>
                                            <td class="text-center"><input type="text" name="item_2" id="item_2"></td>
                                            <td class="text-center"><input type="text" id="item_3" name="item_3"></td>
                                            <td class="text-center">$0.00</td>
                                    ...
                                    <h4>Please adhere to the following instructions:</h4>
                                    <ul>
                                        <li>The above compressed air is for one piston compressor, without dryer. The exhibitor is
                                            responsible for draining off used water daily.</li>
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("inventory/order_forms/form_15_validate/doError"); ?>",
