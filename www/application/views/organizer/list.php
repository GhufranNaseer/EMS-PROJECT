...
<div class="content-wrapper" data-page="organizer">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= base_url('organizer.html'); ?>"><i class="fa fa-dashboard"></i> Organizer</a></li>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <a href="<?= base_url('organizer-add.html') ?>"
...
<script type="text/javascript">
	$(document).ready(function () {
		var oTable = $('#crud-table').dataTable({
			...
			"bServerSide": true,
			"sScrollX":    '100%',
			"sAjaxSource": '<?php echo base_url('organizer-datatable.html'); ?>'+ location.search,
			"bJQueryUI":   true,
