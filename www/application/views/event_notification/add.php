        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="<?= base_url('notification-submit.html') ?>?id=<?= $this->input->get('id') ?>" method="post" id="crd_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="type" id="type" class="form-control notification_type">
                                        <option value="">- select -</option>
                                        <option value="update">Event Updates</option>
                                        <option value="downloads">Downloads</option>
                                        <option value="notification">Notification Alert</option>
                                        <option value="end_user_note">Note for End User Certificate</option>
                                        <option value="trade_visitor_badge_terms">Terms for Trade Visitor Badge</option>
                                        <option value="hotel_reservation_terms">Terms for Hotel Reservation</option>
                                        <option value="display_mobility_terms">Terms for Display Mobility</option>
                                        <option value="vehicle_rental_terms">Terms for Vehicle Rental</option>
                                        <option value="additional_items_terms">Terms for Additional Items</option>
                                    </select>
                                </div>
                            </div>

                            <div class="row notification_type_container" style="display: none">
                                <div class="col-sm-12">
                                    <div class="form-group">
...
<script>
	$(function () {
		doFormValidation({
			...
			'urlValidator': "<?php echo base_url("notification-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
