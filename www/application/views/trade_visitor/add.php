		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						<form action="<?= base_url('trade-visitor-submit.html') ?>?id=<?= $this->input->get('id') ?>" method="post" id="trade_visitor_form"
							...
							<div class="form-group row">
								...
								<div class="col-sm-3">
									...
									<input type="text" class="form-control" name="country" list="country_list" value="Pakistan">
...
<script>
	$(function () {
		doFormValidation({
			...
			'urlValidator': "<?php echo base_url("trade-visitor-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
