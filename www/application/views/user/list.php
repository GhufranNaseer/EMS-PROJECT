...
<div class="content-wrapper" data-page="users">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= base_url('users.html'); ?>"><i class="fa fa-dashboard"></i> User</a></li>
...
<script type="text/javascript">
	$(document).ready(function () {
		var oTable = $('#crud-table').dataTable({
			...
			"bServerSide": true,
			"sScrollX":    '100%',
			"sAjaxSource": '<?php echo base_url('users-datatable.html'); ?>',
			"bJQueryUI":   true,
