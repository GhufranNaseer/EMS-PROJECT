            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Stall Builder Edit</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('stall-builder-edit-submit.html') ?>?id=<?= $this->input->get('id') ?>"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Stall Builder Company</label>
                                        <input type="text" class="form-control" name="company_name"
                                               value="<?= $this->formdata->company_name ?>"
                                               placeholder="Stall Builder Company">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
...
<script>
	$(function () {
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("stall-builder-edit-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
