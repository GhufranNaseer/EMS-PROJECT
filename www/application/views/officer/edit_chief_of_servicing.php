            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Chief Of ServicingOfficer Edit</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('officer-edit-chief-of-servicing-submit.html') ?>?id=<?= $this->input->get('id') ?>"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="contact_person_name" id="contact_person_name" value="<?= ($this->formdata->contact_person) ?>">
                                </div>
                                <div class="col-sm-6">
                                    <label>Mobile Number<span class="text-red">*</span></label>
                                    <input type="number" class="form-control" name="mobile_number" id="mobile_number" value="<?= ($this->formdata->officer_phone) ?>">
                                </div>
                            </div>
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("officer-edit-chief-of-servicing-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
