            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Foreign Delegations Officer Edit</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('officer-edit-foreign-delegations-submit.html') ?>?id=<?= $this->input->get('id') ?>"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="email" class="form-control" name="email" value="<?= ($this->formdata->officer_email)?>" id="email">
                                </div>
                                <div class="col-sm-6">
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("officer-edit-foreign-delegations-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
