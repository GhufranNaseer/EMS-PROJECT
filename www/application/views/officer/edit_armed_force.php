            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Armed Forces (Pakistan) Edit</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('officer-edit-armed-force-submit.html') ?>?id=<?= $this->input->get('id') ?>"
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("officer-edit-armed-force-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
