            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Organizers Edit</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('officer-edit-organizer-submit.html') ?>?id=<?= $this->input->get('id') ?>"
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("officer-edit-organizer-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
