...
<div class="content-wrapper" data-page="officer">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add  Chief of Servicing</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Add Chief of Servicing</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('officer-chief-of-servicing-submit.html') ?>?id=<?= $this->input->get('id') ?>" method="post" id="add_agent_form"
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("officer-chief-of-servicing-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
