        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="<?= base_url('inventory-item-submit.html') ?>" method="post" id="crd_form"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="item_terms" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
...
<script>
	$(function () {
		...
		doFormValidation({
			...
			'urlValidator': "<?php echo base_url("inventory-item-validate.html"); ?>",
