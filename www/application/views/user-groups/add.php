            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"> User Groups Add</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('user-groups-submit.html') ?>" method="post" id="crd_form"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="group_title" id="group_title"
                                               placeholder="User Groups Title" class="form-control">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="superadmin">
                                            <input name="superadmin" id="superadmin" type="checkbox" value="superadmin">
                                            <b> Is super admin? </b>
                                        </label>
                                    </div>
                                </div>
									...
									foreach ($this->usermdl->getAllRights() as $area):
                                        ...
                                        <div class="form-group">
                                            <label for="rights_<?= $index ?>">
                                                <input name="rights[]" id="rights_<?= $index ?>" type="checkbox"
                                                       value="<?= html_escape($area['filename']) ?>">
												<?= $area['cbname'] ?>
                                            </label>
                                        </div>
									<?php endforeach; ?>
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("user-groups-validate.html"); ?>",
