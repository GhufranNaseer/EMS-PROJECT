            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Show Catalogue Detail</h3>
                    </div><!-- /.box-header -->
...
<script type="text/javascript">
	$(document).ready(function () {
		oTable = $('#crud-table').dataTable($.extend(datatable_settings, {
			"sAjaxSource": '<?php echo base_url('show_catalogue_status-report-datatable.html'); ?>?id=<?= $this->input->get('id') ?>',
		}));
		my_datatable(oTable, {
			exportable: true,
