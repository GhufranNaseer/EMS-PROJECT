...
<div class="content-wrapper" data-page="sms_send_to_companies">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            SMS Send To companies
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('sms-send-to-companies-add-submit'); ?>"><i class="fa fa-dashboard"></i>SMS Send To Companies</a></li>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">SMS Send To Companies</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('sms-send-to-companies-add-submit') ?>" method="post" id="crd_form"
...
<script>
	$(function () {
		...
		var faqadd = {
			...
			'urlValidator': "<?php echo base_url("sms-send-to-companies-add-validate"); ?>",
