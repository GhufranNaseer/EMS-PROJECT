							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="location" value="<?= html_escape($this->formdata->location) ?>" placeholder="Location">
									</div>
								</div>
							</div>
...
<script>
	$(function() {
		...
		doFormValidation({
			...
			'urlValidator': "<?php echo base_url("Location_for_meeting-edit-validate.html"); ?>?id=<?= $this->input->get('id') ?>",
