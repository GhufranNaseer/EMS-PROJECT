            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Venue Add</h3>
                    </div><!-- /.box-header -->

                    <div class="box-body">
                        <form action="<?= base_url('demonstration-venue-submit.html') ?>" method="post" id="crd_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label>Venue Address</label>
                                        ...
                                        <input type="hidden" id="venue_long" name="venue_long" >
                                        <input type="text" id="venue_address" class="form-control" name="venue_address" placeholder="Venue Address">
...
<script>
	$(function () {
		...
		doFormValidation({
			...
			'urlValidator': "<?php echo base_url("demonstration-venue-validate.html"); ?>",
