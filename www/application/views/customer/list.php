...
<div class="content-wrapper" data-page="customers">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= base_url('customers.html'); ?>"><i class="fa fa-dashboard"></i> Customer</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                           <form method="get" action="">
                            ...
                            <div class="col-xs-2">
                                <a href="<?= base_url('customer-add.html') ?>"
...
<script type="text/javascript">
	$(document).ready(function () {
		var oTable = $('#crud-table').dataTable({
			...
			"bServerSide": true,
			"sScrollX":    '100%',
			"sAjaxSource": '<?php echo base_url('customers-datatable.html'); ?>' + location.search,
			"bJQueryUI":   true,
