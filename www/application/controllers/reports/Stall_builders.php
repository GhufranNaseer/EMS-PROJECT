...
class Stall_builders extends MY_Controller
{
	...
	function crd_list()
	{
		...
		$this->load->view('stall_builders_report/list');
	}
	...
	function crd_list_datatable()
	{
		...
		$this->datatables
			...
			->add_column('col_action', function ($row) {
				$id = $row['id'];
				$html = '<a href="' . base_url() . 'stall_builders_report-list.html?id=' . urlencode(myid($id)) . '">Report</a>';
	...
	{
		$this->load->view('includes/after_login/head');
		$this->load->view('stall_builders_report/exhibition_list');
	}
	...
	function crd_exhibition_list_datatable()
	{
		...
		$this->datatables
            ...
            ->like("F.form_data","bare_stall_data")
