...
class Display_mobility_report extends MY_Controller
{
	...
	function crd_list()
	{
		...
		$this->load->view('display_mobility_report/list');
	}
	...
	function crd_list_datatable()
	{
		...
		$this->datatables
			...
			->add_column('col_action', function ($row) {
				$id = $row['id'];
				$html = '<a href="' . base_url() . 'display_mobility_report-list.html?id=' . urlencode(myid($id)) . '">Report</a>';
	...
	{
		$this->load->view('includes/after_login/head');
		$this->load->view('display_mobility_report/exhibition_list');
	}

	function export_report() {
		$fileName = 'Display Mobility Report.xls';
